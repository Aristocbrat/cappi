...
const Body6 = () => {
  return (
  <div className='sixthPage my-4 mx-4 d-flex flex-column flex-lg-row flex-wrap'>
  ...
  <div className='w-25 cand pb-5  pb-lg-0'>
      ...
      <div className='position-absolute ss  ps-3'>
      <span className='spanner text-white'>Sep 26, 2021</span><br/>
       <span className='pa  x text-white  w-25'>
        GPT-3 and Open  AI is the future. Let us exlore how it is?</span>
        <p className='rfp pt-2 text-white '>Read Full Article</p>
        </div>
  </div>
  ...
  <p className='rfp  gt ms-lg-3 text-white'>Read Full Article</p>
  </div>
 
  <div className='w-25 gand pb-4 pb-lg-0'>
